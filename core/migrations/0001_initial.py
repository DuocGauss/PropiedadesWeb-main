    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rut_agente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.agente')),
                ('rut_empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='ubicacion',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.ubicacion'),
        ),
        migrations.CreateModel(
            name='Planes',
            fields=[
